            ...
            if self.x > 0 and self.y > 0:
                ...
                if self.loc_id in [12, 16, 18, 19]:                    
                    if self.detectOutOfBound((BSs[self.loc_id - 1][0], BSs[self.loc_id - 1][1])):
                        self.out = True
                        if self.loc_id == 12:
                            dist_1 = self.detectOutOfBound((BSs[12 - 1][0], BSs[12 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[16 - 1][0], BSs[16 - 1][1] + y_interval))
                            if dist_1 is False:
                                self.loc_id = 17
                                self.x = self.x - BSs[12 - 1][0] + BSs[17 - 1][0]
                                self.y = self.y - (BSs[12 - 1][1] + y_interval) + BSs[17 - 1][1]
                            elif dist_2 is False:
                                self.loc_id = 1
                            ...
                            dist_1 = self.detectOutOfBound((BSs[16 - 1][0], BSs[16 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[19 - 1][0], BSs[19 - 1][1] + y_interval))
                            if dist_1 is False:
                                self.loc_id = 1
                                self.x = self.x - BSs[16 - 1][0] + BSs[1 - 1][0]
                                self.y = self.y - (BSs[16 - 1][1] + y_interval) + BSs[1 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[19 - 1][0], BSs[19 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[19 - 1][0] + x_interval, BSs[19 - 1][1] + y_interval / 2))
                            dist_3 = self.detectOutOfBound((BSs[19 - 1][0] + x_interval, BSs[19 - 1][1] - y_interval / 2))
                            if dist_1 is False:
                                self.loc_id = 4
                                self.x = self.x - BSs[19 - 1][0] + BSs[4 - 1][0]
                                self.y = self.y - (BSs[19 - 1][1] + y_interval) + BSs[4 - 1][1]
                ...
                if self.loc_id in [2, 3, 7, 12]:
                    if self.detectOutOfBound((BSs[self.loc_id - 1][0], BSs[self.loc_id - 1][1])):
                        ...
                        if self.loc_id == 12:
                            dist_1 = self.detectOutOfBound((BSs[12 - 1][0], BSs[12 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[7 - 1][0], BSs[7 - 1][1] + y_interval))
                            if dist_1 is False:
                                self.loc_id = 17
                                self.x = self.x - BSs[12 - 1][0] + BSs[17 - 1][0]
                                self.y = self.y - (BSs[12 - 1][1] + y_interval) + BSs[17 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[7 - 1][0], BSs[7 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[3 - 1][0], BSs[3 - 1][1] + y_interval))
                            if dist_1 is False:
                                self.loc_id = 13
                                self.x = self.x - BSs[7 - 1][0] + BSs[13 - 1][0]
                                self.y = self.y - (BSs[7 - 1][1] + y_interval) + BSs[13 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[3 - 1][0], BSs[3 - 1][1] + y_interval))
                            dist_2 = self.detectOutOfBound((BSs[3 - 1][0] - x_interval, BSs[3 - 1][1] + y_interval / 2))
                            dist_3 = self.detectOutOfBound((BSs[3 - 1][0] - x_interval, BSs[3 - 1][1] - y_interval / 2))
                            if dist_1 is False:
                                self.loc_id = 8
                                self.x = self.x - BSs[3 - 1][0] + BSs[8 - 1][0]
                                self.y = self.y - (BSs[3 - 1][1] + y_interval) + BSs[8 - 1][1]
                ...
                if self.loc_id in [1, 2, 4, 8]:
                    if self.detectOutOfBound((BSs[self.loc_id - 1][0], BSs[self.loc_id - 1][1])):
                        self.out = True
                        if self.loc_id == 8:
                            dist_1 = self.detectOutOfBound((BSs[8 - 1][0], BSs[8 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[4 - 1][0], BSs[4 - 1][1] - y_interval))
                            if dist_1 is False:
                                self.loc_id = 3
                            ...
                            dist_1 = self.detectOutOfBound((BSs[4 - 1][0], BSs[4 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[1 - 1][0], BSs[1 - 1][1] - y_interval))
                            if dist_1 is False:
                                self.loc_id = 19
                                self.x = self.x - BSs[4 - 1][0] + BSs[19 - 1][0]
                                self.y = self.y - (BSs[4 - 1][1] - y_interval) + BSs[19 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[1 - 1][0], BSs[1 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[1 - 1][0] - x_interval, BSs[1 - 1][1] + y_interval / 2))
                            dist_3 = self.detectOutOfBound((BSs[1 - 1][0] - x_interval, BSs[1 - 1][1] - y_interval / 2))
                            if dist_1 is False:
                                self.loc_id = 16
                                self.x = self.x - BSs[1 - 1][0] + BSs[16 - 1][0]
                                self.y = self.y - (BSs[1 - 1][1] - y_interval) + BSs[16 - 1][1]
                ...
                if self.loc_id in [8, 13, 17, 18]:
                    if self.detectOutOfBound((BSs[self.loc_id - 1][0], BSs[self.loc_id - 1][1])):
                        ...
                        if self.loc_id == 8:
                            dist_1 = self.detectOutOfBound((BSs[8 - 1][0], BSs[8 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[13 - 1][0], BSs[13 - 1][1] - y_interval))
                            if dist_1 is False:
                                self.loc_id = 3
                                self.x = self.x - BSs[8 - 1][0] + BSs[3 - 1][0]
                                self.y = self.y - (BSs[8 - 1][1] - y_interval) + BSs[3 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[13 - 1][0], BSs[13 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[17 - 1][0], BSs[17 - 1][1] - y_interval))
                            if dist_1 is False:
                                self.loc_id = 7
                                self.x = self.x - BSs[13 - 1][0] + BSs[7 - 1][0]
                                self.y = self.y - (BSs[13 - 1][1] - y_interval) + BSs[7 - 1][1]
                            ...
                            dist_1 = self.detectOutOfBound((BSs[17 - 1][0], BSs[17 - 1][1] - y_interval))
                            dist_2 = self.detectOutOfBound((BSs[17 - 1][0] + x_interval, BSs[17 - 1][1] + y_interval / 2))
                            dist_3 = self.detectOutOfBound((BSs[17 - 1][0] + x_interval, BSs[17 - 1][1] - y_interval / 2))
                            if dist_1 is False:
                                self.loc_id = 12
                                self.x = self.x - BSs[17 - 1][0] + BSs[12 - 1][0]
                                self.y = self.y - (BSs[17 - 1][1] - y_interval) + BSs[12 - 1][1]
                                ...
                                print('error-----------------------------')
    def checkHandoff(self, mobileDevices, BSs, noise, interferenceGain, time, nearCells, threshold=-90):
        global TIMES
        if self.SINR <= threshold:
            ...
            #     if idx + 1 in nearCells[self.loc_id].keys() or idx + 1 == self.loc_id:
            #         SINRValue.append((self.calSINR(mobileDevices, BS, noise, interferenceGain, nearCells, BSs), idx))           
            # self.cell_id = SINRValue[max(range(len(SINRValue)), key=SINRValue.__getitem__)][1] + 1
